  ...
  return (
    <section className="bg-white font-monts mt-6">
      <div className="max-w-[1100px] xl:max-w-[1440px] mx-auto px-4">
        ...
        {/* grids */}
        <div className="flex items-center justify-center gap-x-10 xl:gap-x-20 gap-y-10 flex-wrap mt-16">
          {/* flex1 */}
          <div className="border-[0.5px] border-black rounded-[15px] p-4 w-[310px] xl:max-w-[339px]">
            <div>
          ...
          {/* flex2 */}
          <div className="border-[0.5px] border-black rounded-[15px] px-4 pt-4 pb-10 w-[310px] xl:max-w-[339px]">
